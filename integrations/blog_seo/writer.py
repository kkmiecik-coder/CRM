...
def write_article(topic_title, links, category_names):
    ...
    user = ("Temat: %s\n\nWpleć te linki wewnętrzne (użyj dokładnych URL, klasa CSS kontakt-link-descr, "
            ...
            "Dobierz NAJLEPIEJ PASUJĄCĄ do treści kategorię bloga (pole category) z tej listy: %s.%s\n"
            "Napisz kompletny artykuł." % (topic_title, links_listing, cats, _brand_facts_block()))
    ...
    # Kategorię wybiera model spośród podanej listy (dopasowanie do realnej treści); walidacja + fallback.
