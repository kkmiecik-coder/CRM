...
from modules.sales.validators import validate_application_data, validate_files
...
@sales_bp.route('/admin/api/application/<int:application_id>/nda/<int:file_number>')
@require_module_access('sales')
def download_nda(application_id, file_number=1):
    """Pobieranie pliku NDA (1 lub 2)"""
    try:
        application = SalesApplication.query.get_or_404(application_id)
