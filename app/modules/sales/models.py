...
Modele dla systemu rekrutacji handlowców.

Tabele:
- sales_applications: Dane aplikacji rekrutacyjnych handlowców
...
class SalesApplication(db.Model):
    """
    Model dla aplikacji rekrutacyjnych handlowców
    ...
    address = db.Column(db.String(255), nullable=False, comment='Adres (ulica i numer)')
    ...
    # ============================================================================
    about_text = db.Column(db.Text, comment='Tekst o sobie (dlaczego chcę zostać handlowcem)')
    ...
    def __repr__(self):
        return f'<SalesApplication {self.email} - {self.status}>'