...
async function generateNDA() {
    ...
    try {
        const response = await fetch('/sales/api/application/generate-nda', {
            method: 'POST',
            headers: {
...
async function submitForm() {
    ...
    try {
        ...
        const checkEmailResponse = await fetch('/sales/api/application/check-email', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        const response = await fetch('/sales/api/application/submit', {
            method: 'POST',
            body: formDataToSend
        });
